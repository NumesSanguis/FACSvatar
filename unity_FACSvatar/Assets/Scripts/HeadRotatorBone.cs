...
public class HeadRotatorBone : MonoBehaviour {
    ...
    void Start () {
        ...
        // gameObject.demo_ready_armature.
        //jointObj = this.gameObject.transform.Find("head");
	...
	public IEnumerator RequestHeadRotation(JObject head_pose)
	{
		...
		//Debug.Log("Head rotation: " + head_pose["pose_Rx"] + ", " + head_rotation[1] + ", " + head_rotation[2]);
        ...
        //rotation.eulerAngles = new Vector3 (head_pose["pose_Rx"], head_rotation[1], head_rotation[2]);
